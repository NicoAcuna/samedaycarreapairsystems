        ...
        <div className="grid grid-cols-2 divide-x divide-neutral-100">
          <div className="p-5 space-y-3">
            <div>
              ...
              <div className="relative inline-flex items-center gap-4" ref={whatsAppMenuRef}>
                ...
                <button
                  ...
                  className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-green-500 text-white hover:bg-green-600 transition-colors"
