    ...
    <div className="min-h-screen bg-neutral-50 py-8 px-4">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-5 no-print">
          <div className="text-xs text-neutral-400">{job.company?.name || 'Same Day Car Repair'} · {jobType === 'service' ? 'Service Report' : jobType === 'diagnosis' ? 'Diagnosis Report' : jobType === 'repair' ? 'Repair Report' : 'Inspection Report'}</div>
